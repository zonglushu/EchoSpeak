...
import type { NotationGuide } from '@echospeak/types';

export interface NotationLegendProps {
  guide: NotationGuide[];
  title?: string;
}

export const NotationLegend: React.FC<NotationLegendProps> = ({ guide, title = '如何看“发音谱子” (How to Read Prosody Script)' }) => {
  return (
